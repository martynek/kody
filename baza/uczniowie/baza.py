...
def main(args):
    # konfiguracja#
    baza = 'uczniowie' #tu poprawic
    tabele = ['uczniowie' , 'klasy' , 'przedmioty' , 'oceny'] #tu poprawic
    roz = '.csv' # tu poprawic
    naglowki = False  # cczy pliki zrodlowe zawieraja naglowki #tu poprawic
    ...
    for tab in tabele:
        ...
        dane = czytaj_dane(tab + roz, separator=',') #tu poprawic
        ile_d = len(dane[0])
        if ile > ile_d:
